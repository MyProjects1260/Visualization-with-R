...
```{r}
# Importing data
df <- read_csv('C:/Users/Mohamed/Downloads/archive (1)/bestsellers with categories.csv')
...
data <- read_csv('C:/Users/Mohamed/Downloads/archive (2)/charts.csv')
...
df %>% 
  ...
  hc_credits(enabled = TRUE, text = '@mohamed_ben_romdhane')
